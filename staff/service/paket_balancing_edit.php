...
<form method="POST" action="paket_proses_update.php">
	<table>
		...
		<tr>
			<td>ID Balancing</td>
			<td><input type="text" name="id_balancing" value="<?=$data['idbalancing']?>"></td>
		</tr>
		<tr>
			<td>Nama Balancing</td>
			<td><input type="text" name="nama_balancing" value="<?=$data['namabalancing']?>"></td>
		</tr>
		<tr>
			<td>Harga</td>
			<td><input type="text" name="harga_spooring" value="<?=$data['hargabalancing']?>"></td>
		</tr>
		<tr>
			<td></td>
