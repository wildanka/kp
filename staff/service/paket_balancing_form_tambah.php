...
<div id="wrapper">
	...
	<div id="content-page">
		<div class="container-fluid" >
			...
			<div class="row">
				<div class="content">
					<form method="post" action="paket_balancing_proses_tambah.php">
						<table>
							<tr>
								<td colspan="2">Data Paket Balancing</td>
							</tr>
							<tr>
								<td>ID Paket</td>
								<td>
							...
							<tr>
								<td>ID Balancing</td>
								<td>
									<select class="form-control" name="id_balancing">
										<option value="" disabled selected hidden>Pilih Balancing</option>
										<?php
										$res=mysqli_query($link,"select id_balancing, nama from balancing_4_roda");
										while($data=mysqli_fetch_array($res))
										{
